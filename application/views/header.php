        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-7">
              ...
              <nav class="menu collapse navbar-collapse">
               <ul class="menu-list nav navbar-nav">
                <li class="active"><a href="<?php echo site_url('principal/index');?>">Inicio</a></li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Limpieza</a></li> 
                ...
                <li><a href="<?php echo site_url('principal/sucursales');?>">Sucursales</a></li>
